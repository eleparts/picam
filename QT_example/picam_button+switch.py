# 엘레파츠 pi-cam kit 
# picam_button_switch.py
# QT app 전체화면 + LCD 화면 터치 버튼 + GPIO 스위치 촬영 예제
...
# 촬영 및 종료 함수 + 촬영 함수 호출 중 버튼 LOCK 기능
...
def capture_done(job):
    ...
    GPIO.add_event_detect(camera_sw, GPIO.FALLING, callback=button_clicked, bouncetime=1500)
...
# 함수 호출 동작 설정
button.clicked.connect(button_clicked)                                                      # 화면 터치 
